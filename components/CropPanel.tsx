...
type AspectRatio = 'libre' | '1:1' | '16:9';

const CropPanel: React.FC<CropPanelProps> = ({ onApplyCrop, onSetAspect, isLoading, isCropping }) => {
  const [activeAspect, setActiveAspect] = useState<AspectRatio>('libre');
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col items-center gap-4 animate-fade-in backdrop-blur-sm">
      <h3 className="text-lg font-semibold text-gray-300">Rogner l'image</h3>
      <p className="text-sm text-gray-400 -mt-2">Cliquez et faites glisser sur l'image pour sélectionner une zone à rogner.</p>
